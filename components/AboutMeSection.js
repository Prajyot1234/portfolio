            ...
            <div className='w-full max-w-7xl mx-auto lg:w-11/12'>
                <div className='mt-14 mb-14 text-center'>
                    <div className=''>
                        ...
                        <p className='text-faint w-11/12 py-4 mx-auto lg:w-5/12'>I&apos;m a Front-End Developer for <a target="_blank" rel="noreferrer" className='text-theme' href='https://kloudspot.com/'>Kloudspot</a> in Bangalore, India.
